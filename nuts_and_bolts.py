# Copyright 2010 D1plo1d, hmeyer

from openscad import *

# This library is dual licensed under the 
# GPL 3.0 and the GNU Lesser General Public License as per
...
def test_NutsAndBolts():
	...
	openscad.fn = 360
	t = union([
		translate([0,15], nutHole(3, proj=-1) ),
